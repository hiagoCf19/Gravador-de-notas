...
export const NoteCard = ({ note, onNoteDeleted }: NoteCardProps) => {
  return (
    <Dialog.Root>
      ...
      <Dialog.Trigger className='rounded-md outline-none text-left bg-slate-800 flex flex-col gap-5 p-5 overflow-hidden relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
